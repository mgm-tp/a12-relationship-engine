...
export function sortedRelationshipFormEngineProvider(componentName: string): React.ComponentType<View> | undefined {
	const components: { [name: string]: React.ComponentType<View> | undefined } = {
		SortedRelationshipFormEngine: CustomRelationshipFormEngine
	};

	return components[componentName];
}

export default SimpleCDMModule;
