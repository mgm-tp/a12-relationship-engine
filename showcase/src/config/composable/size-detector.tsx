...
/**
 * Wraps the application with the SizeProvider for responsive breakpoint detection
 */
export const withSizeDetector = <T extends A12ApplicationConfig>(cfg: T) => addWrapper<T>(SizeProvider, "outer")(cfg);
