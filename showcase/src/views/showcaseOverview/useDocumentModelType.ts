...
/**
 * Copy of the crud hook to return the document model info of the overview model from the model graph
 */
...
function findDocumentModelType(dmName: string, modelGraph: ModelGraph): ModelGraph.DocumentModel {
