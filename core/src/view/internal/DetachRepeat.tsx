...
/** @internal */
export function DetachedRepeat(props: FormModelMap.FormModelComponentProps<FormModel.DetachedRepeat>): React.ReactNode {
	...
	return (
		<div style={{ border: "solid 2px amber", padding: 6, textAlign: "center" }}>
