		...
		relationship: {
			component: {
				...
				"dual-pane": {
					...
					"available-items": "Available Elements",
					"candidates-empty": "No entries available to select.",
					"links-empty": "Empty selection."
				},
				"drop-down": {
				...
				"table-list": {
					...
					"edit-dialog": {
						...
						veto: {
							...
							message: "Do you really want to close? This dialog contains unsaved changes.",
