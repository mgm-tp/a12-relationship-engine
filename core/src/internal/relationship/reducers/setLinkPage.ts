	...
	const updatedLinkInstance: Relationship.LinkInstance = {
		...
		linkQuery: {
			...
			page: {
				...
				limit: limit ?? linkInstance.linkQuery.page.limit,
				offset: offset ?? linkInstance.linkQuery.page.offset
			}
		},
		linkPagination: {
			...linkInstance.linkPagination,
			pageNumber: pageNumber ?? linkInstance.linkPagination.pageNumber
		}
	};
