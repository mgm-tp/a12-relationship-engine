 ...
 * @internal
 */
export function cddDocumentDescriptorSelector(
	state: object,
	activityId: string,
	...
	return isSetCdd(data) ? getNearestDocumentDescriptor(data, documentPath) : defaultDocumentDescriptorSelector(data);
}

function defaultDocumentDescriptorSelector(data: object | undefined): DocumentDescriptor {
	assertCondition(FormActivity.Data.SingleDocumentData.isInstance(data));
