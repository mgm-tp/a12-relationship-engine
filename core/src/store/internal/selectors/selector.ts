...
/** A typed selector function that derives a value of {@link ReturnType} from {@link State}. */
...
/**
 * @internal
 * Creates a memoized selector using WeakMap-based memoization (unbounded, GC-friendly).
 * Use when:
 * - The selector is called with object references that change frequently (e.g. per-row).
 * - You want cache entries to be garbage-collected automatically when inputs are released.
 */
