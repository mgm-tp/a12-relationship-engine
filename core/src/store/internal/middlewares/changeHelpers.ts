...
/** @internal Dispatches SCDM recomputation if the activity is a CDM activity. */
export function dispatchScdmIfCdm(activityId: string, state: object, store: MiddlewareAPI): void {
