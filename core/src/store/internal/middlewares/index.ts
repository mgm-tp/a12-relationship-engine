...
import { onLinkDeletedMiddleware } from "./onLinkDeleted.js";
import { onAddDocumentMiddleware } from "./onAddDocument.js";
import { onLinkRestoredMiddleware } from "./onLinkRestored.js";
import { onOpenEditModalMiddleware } from "./onOpenEditModal.js";
import { onLinkRowClickedMiddleware } from "./onLinkRowClicked.js";
import type { RelationshipEngineMiddlewareOptions } from "./types.js";
...
export function createRelationshipEngineMiddlewares(_options?: RelationshipEngineMiddlewareOptions): Middleware[] {
	return [
		...
		onLinkDeletedMiddleware,
		onLinkRestoredMiddleware,
		onLinkRowClickedMiddleware,
		onDetachedRepeatTransactionMiddleware,
		onOpenEditModalMiddleware,
		onAddDocumentMiddleware,
