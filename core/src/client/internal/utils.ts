...
import type { ModelGraph, QueryJsonRpc2Response } from "@com.mgmtp.a12.dataservices/dataservices-access";

/* @internal */
export function getLink(links: QueryJsonRpc2Response.Link[], linkId: string): QueryJsonRpc2Response.Link | undefined {
	return links.find((link) => link.linkId === linkId && link.type === "LINK");
}
...
/* @internal */
export function isValidLink(link: QueryJsonRpc2Response.Link): link is QueryJsonRpc2Response.Link {
	return (
		link &&
		!!link.linkId &&
